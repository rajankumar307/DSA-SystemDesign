...
public class TestClass {
   ...
   @Test
    public void testForSingleUserSlidingWindow(){
        RateLimiterStrategy rateLimiterStrategy=new SlidingWindowRateLimiter(RateLimiterConstant.MAX_REQUESTS,RateLimiterConstant.WINDOW_SIZE);
        RateLimiter rateLimiter=new RateLimiter(rateLimiterStrategy);
